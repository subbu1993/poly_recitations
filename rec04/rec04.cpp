...
class Sandwich10
{
  ...
  public:
    ...
    Sandwich10(int numberOfBread = 2,int quantityOfCheese = 1,double amountOfMayo = 0.1 , int numberOfTomatoes = 2, double amountOfMustard = 1.0) : numberOfBread(numberOfBread),quantityOfCheese(quantityOfCheese),numberOfTomatoes(numberOfTomatoes),amountOfMustard(amountOfMustard),amountOfMayo(amountOfMayo)
    {
...
class Sandwich
{
  ...
  public:
    ...
    Sandwich(int numberOfBread = 2,int quantityOfCheese = 1,double amountOfMayo = 0.1 , int numberOfTomatoes = 2, double amountOfMustard = 1.0) : numberOfBread(numberOfBread),quantityOfCheese(quantityOfCheese),numberOfTomatoes(numberOfTomatoes),amountOfMustard(amountOfMustard),amountOfMayo(amountOfMayo)
    {
...
int main()
{
  ...
  //truck1.insertSandwich(s10);
  //truck1.checkBeforLeaving();
  Sandwich regular;
  Sandwich regularAgain;
  regularAgain.setMustard(0);
  Sandwich extraCheese(2,2);
  Sandwich anotherRegular;
  SandwichTruck finalTruck;
  finalTruck.insertSandwich(regular);
  finalTruck.insertSandwich(regularAgain);
  finalTruck.insertSandwich(extraCheese);
  finalTruck.insertSandwich(anotherRegular);
  finalTruck.checkBeforLeaving();
}
